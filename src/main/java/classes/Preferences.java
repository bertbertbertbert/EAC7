...
/**
 * Represents user preferences for betting behavior and notifications. This
 * class manages user settings such as minimum odds, maximum bet amount, and
 * notification preferences. Kept simple and purely didactic.
 *
 * @author IOC
 * @version 1.0
 */
public class Preferences {
     ...
     *
     * @param notificationsEnabled true to enable notifications, false to
     * disable them
     */
