...
/**
 * Tracks and manages betting statistics for a user.
 * This class maintains the total number of bets placed and the total amount wagered.
 * It provides methods to retrieve statistics and register new bets.
 * Kept minimal and purely didactic for educational purposes.
 * 
 * @author IOC
 * @version 1.0
 */
public class UserStats {
    ...
    /** 
     * Polimorfic constructor
     * First of all, the version without parameters. 
     * Initialize the two properties to its default values. totalBets to 0 and totalAmount to 0.0
     *  
    */
    public UserStats() {
     ...
     * @param totalAmount the initial total amount wagered (must be non-negative)
    ...
    /**
     * Calculates the average amount per bet.
     * Returns 0.0 if no bets have been placed to avoid division by zero.
     * 
    ...
    /**
     * Registers a new bet and updates the total statistics.
     * Increments the total bet count and adds the amount to the total wagered.
     * 
